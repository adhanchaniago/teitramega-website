            ...
            <!-- Intro + Action -->
            <section class="site-section site-section-top site-section-light themed-background-teitramega">
                <div class="container">
                    <div class="push text-center">
                        ...
                        <a href="#" class="btn btn-lg btn-success push-right-left"><strong>Purchase</strong></a>
                        <a href="#" class="btn btn-lg btn-info push-right-left"><strong>Live Preview</strong></a>
                    </div>
                    <div class="site-promo-img visibility-none" data-toggle="animation-appear" data-animation-class="animation-slideUpQuick" data-element-offset="0">
                        <img src="<?php echo base_url('public/'); ?>img/placeholders/screenshots/promo_welcome.png" alt="">
                    </div>
                </div>
            </section>
            <!-- END Intro + Action -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 clearfix push">
                            <img src="<?php echo base_url('public/'); ?>img/placeholders/screenshots/promo_1.png" alt="" class="img-responsive pull-right visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-200" style="max-width: 450px; margin-right: -130px;">
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-sm-pull-6 clearfix push">
                            <img src="<?php echo base_url('public/'); ?>img/placeholders/screenshots/promo_2.png" alt="" class="img-responsive pull-left visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInRight" data-element-offset="-200" style="max-width: 450px; margin-left: -130px;">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="site-section site-content border-bottom overflow-hidden">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 clearfix push">
                            <img src="<?php echo base_url('public/'); ?>img/placeholders/screenshots/promo_3.png" alt="" class="img-responsive pull-right visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-200" style="max-width: 450px; margin-right: -130px;">
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div id="testimonials-carousel" class="carousel slide carousel-html" data-ride="carousel" data-interval="4000">
                        <div class="carousel-inner text-center">
                            <div class="active item">
                                <blockquote>
                                    <p><img src="<?php echo base_url('public/'); ?>img/placeholders/avatars/avatar13@2x.jpg" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar-2x"></p>
                            ...
                            <div class="item">
                                <blockquote>
                                    <p><img src="<?php echo base_url('public/'); ?>img/placeholders/avatars/avatar2@2x.jpg" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar-2x"></p>
                                    <h3>It just works!</h3>
                            ...
                            <div class="item">
                                <blockquote>
                                    <p><img src="<?php echo base_url('public/'); ?>img/placeholders/avatars/avatar1@2x.jpg" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar-2x"></p>
                            ...
                            <div class="item">
                                <blockquote>
                                    <p><img src="<?php echo base_url('public/'); ?>img/placeholders/avatars/avatar7@2x.jpg" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar-2x"></p>
